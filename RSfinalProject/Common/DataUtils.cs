...
namespace RSfinalProject
{
    public class DataUtils
    {
        ...
        public Dictionary<DatasetType, Tuple<Users, Items>> Split(double subsetSize, double datasetSize,
            Tuple<Users, Items> data, DatasetType smallSetType, DatasetType largeSetType)
        {
            //logger.info("Start data split...");
            Dictionary<DatasetType, Tuple<Users, Items>> result = new Dictionary<DatasetType, Tuple<Users, Items>>();
